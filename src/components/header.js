...
function Menu () {
  return (
    <div className="flex w-full text-center text-[16px] space-x-12 justify-center text-[#000212] px-24">
      <Link href="/waitlist">
      <div className="text-[16px]  hover:bg-purple-600 hover:text-white pt-1 rounded-md h-8 w-24  cursor-pointer mr-3">
        Personal
      </div>
      </Link>
      <Link href="/waitlist">
  ...
  return (
    <div className="flex px-1 py-1.5 lg:px-12 items-right bg-white lg:items-center w-full lg:justify-between lg:text-center">
      ...
      <div className="hidden lg:flex">
        <Menu />
        <div className="flex   text-black hover:bg-purple-600 hover:text-white pt-1 rounded-md h-8 w-24 text-center px-2 cursor-pointer mr-10">
          SignIn
        </div>
